...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "session_timeout_test01.json"))
...
class TestCase(TestCaseTemplate):
    ...
    def test01(self, test_data):
        ...
        self.assertTrue(result, "Verify auto logoff after session time out failed.")
        self._login()
        result = self._is_test_page_loaded()
