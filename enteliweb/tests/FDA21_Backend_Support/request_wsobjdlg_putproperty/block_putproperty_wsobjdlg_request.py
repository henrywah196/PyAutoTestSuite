...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "block_putproperty_wsobjdlg_request.json"))
...
class TestCase(TestCaseTemplate):
    ...
    @data(*getTestingData())
    def test01_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg/putproperty' for '%s' without ESignature will be blocked if feature is enabled with optional comment"%test_data.getObjRef()
        ...
        # send POST request
        self._wsobjdlg_putproperty(test_data)
    ...
    @data(*getTestingData())
    def test02_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg/putproperty' for '%s' without ESignature will be blocked if feature is enabled with mandatory comment"%test_data.getObjRef()
    ...
    @data(*getTestingData())   
    def test03_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s with invalid ESignature will be blocked if feature is enabled with optional comment"%test_data.getObjRef()
        ...
        # send POST request
        self._wsobjdlg_putproperty(test_data, self.password)
    ...
    @data(*getTestingData())   
    def test04_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s with invalid ESignature will be blocked if feature is enabled with mandatory comment"%test_data.getObjRef()
        ...
        # send POST request
        self._wsobjdlg_putproperty(test_data, self.password, "esign message")
    ...
    @data(*getTestingData())
    def test05_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s with valid ESignature will get through if feature is enabled with optional comment"%test_data.getObjRef()
        ...
        self._wsobjdlg_putproperty(test_data, password_base64)
    ...
    @data(*getTestingData())
    def test06_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s with valid ESignature and comment will get through if feature is enabled with mandatory comment"%test_data.getObjRef()
        ...
        # send POST request
        password_base64 = base64.b64encode(self.password)
        self._wsobjdlg_putproperty(test_data, password_base64, "esign message")
    ...
    @data(*getTestingData())   
    def test07_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s with valid ESignature but no comment will be blocked if feature is enabled with mandatory comment"%test_data.getObjRef()
    ...
    @data(*getTestingData())  
    def test08_putpropety_wsobjdlg(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s without ESignature will get through if feature is disabled with optional comment"%test_data.getObjRef()
    ...
    def _verify_state_not_changed(self):
        ...
        result = ('status="OK"' in response_content) and ('value="%s"'%self.test_data.property_value_verify not in response_content)
    ...
    def _verify_state_changed(self):
        ...
        self._wsbac_getproperty(self.test_data.site, self.test_data.device_number, self.test_data.object_type, self.test_data.instance_number, self.test_data.property_name_verify)
        response_content = self.r.content
        result = ('status="OK"' in response_content) and ('value="%s"'%self.test_data.property_value_verify in response_content)
    ...
    def _wsobjdlg_putproperty(self, parameters, esignature=None, comment=None):
        """ create an object on target device """
        
        url = "%s/wsobjdlg/putproperty"%self.base_url
