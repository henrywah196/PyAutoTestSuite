...
class TestCase(TestCaseTemplate):
    ...
    def test0101_command_wsbac(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsbac/commandauto from object list' for '%s' without ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test0102_command_wsbac(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsbac/commandauto from watchlist widget' for '%s' without ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test0201_command_wsbac(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsbac/commandauto from object list' for '%s' with invalid ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test0202_command_wsbac(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsbac/commandauto from watchlist widget' for '%s' with invalid ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test0301_command_wsbac(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsbac/commandauto from object list' for '%s' with valid ESignature will get through if feature is enabled"%test_data.getObjRef()
    ...
    def test0302_command_wsbac(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsbac/commandauto from watchlist widget' for '%s' with valid ESignature will get through if feature is enabled"%test_data.getObjRef()
    ...
    def _wsbac_command_auto_array(self, siteName, deviceNumber, objType, objInstance, esignature=None):
        """ create an object on target device """
        obj_ref = "//%s/%s.%s%s"%(siteName, deviceNumber, objType, objInstance)
