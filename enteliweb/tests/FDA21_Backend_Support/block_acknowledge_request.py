...
class TestCase(TestCaseTemplate):
    ...
    def test01_createobject_wsbac(self):
        
        self._testMethodDoc = "Request 'wsalarm/acknowledge' for single transaction without ESignature will be blocked if feature is enabled"
    ...
    def test02_createobject_wsbac(self):
        
        self._testMethodDoc = "Request 'wsalarm/acknowledge' for single transaction with invalid ESignature will be blocked if feature is enabled"
    ...
    def test03_createobject_wsbac(self):
        
        self._testMethodDoc = "Request 'wsalarm/acknowledge' for single transaction with valid ESignature will get through if feature is enabled"
    ...
    def test04_createobject_wsbac(self):
        
        self._testMethodDoc = "Request 'wsalarm/acknowledge' for single transaction without ESignature will get through if feature is disabled"
