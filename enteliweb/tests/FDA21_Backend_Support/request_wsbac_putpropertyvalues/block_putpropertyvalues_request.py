...
class TestCase(TestCaseTemplate):
    ...
    @data(*getTestingData())
    def test01_putpropertyvalues_wsbac(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac/putpropertyvalues' for '%s' without ESignature will be blocked if feature is enabled with optional comment"%test_data.getObjRef()
        ...
        if test_data.device_category == "3rd":
            ...
            if 'value="ready"' in response_content:
                self.test_data.property_value = "halt"
                self.test_data.property_value_verify = "halt"
        ...
        # send POST request
        self._wsbac_putpropertyvalues(self.test_data)
    ...
    @data(*getTestingData())
    def test02_putpropertyvalues_wsbac(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac/putpropertyvalues' for '%s' without ESignature will be blocked if feature is enabled with mandatory comment"%test_data.getObjRef()
    ...
    @data(*getTestingData())   
    def test03_putpropertyvalues_wsbac(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac//putpropertyvalues' for '%s' with invalid ESignature will be blocked if feature is enabled with optional comment"%test_data.getObjRef()
    ...
    @data(*getTestingData())   
    def test04_putpropertyvalues_wsbac(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac//putpropertyvalues' for '%s' with invalid ESignature will be blocked if feature is enabled with mandatory comment"%test_data.getObjRef()
        ...
        # send POST request
        self._wsbac_putpropertyvalues(test_data, self.password, "esign message")
    ...
    @data(*getTestingData())
    def test05_putpropertyvalues_wsbac(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac//putpropertyvalues' for '%s' with valid ESignature will get through if feature is enabled with optional comment"%test_data.getObjRef()
    ...
    @data(*getTestingData())
    def test06_putpropertyvalues_wsbac(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac//putpropertyvalues' for '%s' with valid ESignature and comment will get through if feature is enabled with mandatory comment"%test_data.getObjRef()
    ...
    @data(*getTestingData())   
    def test07_putpropertyvalues_wsbac(self, test_data):
        
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac//putpropertyvalues' for '%s' with alid ESignature but no comment will be blocked if feature is enabled with mandatory comment"%test_data.getObjRef()
    ...
    @data(*getTestingData())  
    def test08_putpropertyvalues_wsbac(self, test_data):
    ...
    def _wsbac_putpropertyvalues(self, parameters, esignature=None, comment=None):
