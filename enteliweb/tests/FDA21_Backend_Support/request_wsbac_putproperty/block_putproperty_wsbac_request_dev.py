...
# Global Settings
TEST_DATA = { "object_type" : "DEV", "site" : "$LocalSite", "device_number" : "1300", "instance_number" : "1300", "object_name" : "Henry_Test_DEV1300", "property_name" : "Time_Sync_Timer", "property_value" : "%dynamic%", "property_name_verify" : "Time_Sync_Timer", "property_value_verify" : "%dynamic%"}
...
class TestCase(TestCaseTemplate):
    ...
    def setUp(self):
        ...
        self.test_data.property_value = str(int(self.value_before_test) + 50000)
    ...
    def test06_putpropety_wsbac(self):
        ...
        # send POST request
        password_base64 = base64.b64encode(self.password)
        self._wsbac_putproperty(test_data, password_base64, "e")
    ...
    def test07_putpropety_wsbac(self):
        ...
        test_data = self.test_data
        self._testMethodDoc = "Request 'wsbac//putproperty' for %s with valid ESignature bu no comment will be blocked if feature is enabled with mandatory comment"%test_data.getObjRef()
    ...
    def test08_putpropety_wsbac(self):
        ...
        test_data = self.test_data
        self._testMethodDoc = "Request 'wsbac//putproperty' for %s without ESignature will get through if feature is disabled with optional comment"%test_data.getObjRef()
    ...
    def _verify_state_changed_dev(self):
        ...
        response_content = self.r.content
        value_after_test = self._fetch_property_value(response_content)
        print "Before test, DEV.Time_Sync_Timer = %s"%self.value_before_test
