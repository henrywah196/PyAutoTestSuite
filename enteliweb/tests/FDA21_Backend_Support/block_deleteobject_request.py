...
class TestCase(TestCaseTemplate):
    ...
    def test01_deleteobject_wsbac(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsbac/deleteobject' for '%s' without ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test02_deleteobject_wsbac(self, test_data):
        ...
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac/deleteobject' for '%s' with invalid ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test03_deleteobject_wsbac(self, test_data):
        ...
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsbac/deleteobject' for '%s' with valid ESignature will get through if feature is enabled"%test_data.getObjRef()
