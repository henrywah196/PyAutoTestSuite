...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "block_createobject_request_02.json"))
...
class TestCase(TestCaseTemplate):
    ...
    def test04_createobject_wsbac(self, test_data):
        ...
        # send POSt request
        self._wsbac_createobject(test_data.site, test_data.device_number, test_data.object_type, test_data.instance_number, test_data.object_name, self.password, "esign message")
    ...
    @data(*getTestingData())    
    def test05_createobject_wsbac(self, test_data):
    ...
    @data(*getTestingData())    
    def test06_createobject_wsbac(self, test_data):
        ...
        # send POSt request
        password_base64 = base64.b64encode(self.password)
        self._wsbac_createobject(test_data.site, test_data.device_number, test_data.object_type, test_data.instance_number, test_data.object_name, password_base64, "esign message")
    ...
    @data(*getTestingData())    
    def test07_createobject_wsbac(self, test_data):
    ...
    @data(*getTestingData())    
    def test08_createobject_wsbac(self, test_data):
