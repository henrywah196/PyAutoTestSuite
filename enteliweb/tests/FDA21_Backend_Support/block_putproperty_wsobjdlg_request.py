...
class TestCase(TestCaseTemplate):
    ...
    def test01_putpropety_wsobjdlg(self, test_data):
        ...
        self._testMethodDoc = "Request 'wsobjdlg/putproperty' for '%s' without ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test02_putpropety_wsobjdlg(self, test_data):
        ...
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s with invalid ESignature will be blocked if feature is enabled"%test_data.getObjRef()
    ...
    def test03_putpropety_wsobjdlg(self, test_data):
        ...
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s with valid ESignature will get through if feature is enabled"%test_data.getObjRef()
    ...
    def test04_putpropety_wsobjdlg(self, test_data):
        ...
        self.test_data = test_data
        self._testMethodDoc = "Request 'wsobjdlg//putproperty' for %s without ESignature will get through if feature is disabled"%test_data.getObjRef()
    ...
    def _wsobjdlg_putproperty(self, parameters, esignature=None):
        """ create an object on target device """
