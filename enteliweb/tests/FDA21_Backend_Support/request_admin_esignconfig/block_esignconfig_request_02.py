...
# Test Case   : 
#
# Description : change config from esign: true, comment: false to esign: true, comment: true
#
################################################################################################
import settings
...
class TestCase(TestCaseTemplate):
    ...
    def test01_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to enable mandatory comment without ESignature password"
    ...
    def test02_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to enable mandatory comment with incorrect ESignature password"
    ...
    def test03_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to enable mandatory comment with correct ESignature password"
    ...
    def _verify_state_changed(self):
        ...
        for row in rows:
            name = row.Name
            value = row.Value
            self.assertEqual(value, '1', "verify  '%s' setting is changed to 1 failed"%name)
