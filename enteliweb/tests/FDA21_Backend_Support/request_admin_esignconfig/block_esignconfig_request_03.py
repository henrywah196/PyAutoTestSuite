...
# Test Case   : 
#
# Description : change config from esign: true, comment: true to esign: true, comment: false
#
################################################################################################
import settings
...
class TestCase(TestCaseTemplate):
    ...
    def test01_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to disable mandatory comment without ESignature password"
    ...
    def test02_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to disable mandatory comment with incorrect ESignature password"
        
        # send POST request
        self._admin_esignconfig(self.password, "esing messgae")
    ...
    def test03_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to disable mandatory comment with incorrect ESignature comment"
    ...
    def test04_esignconfig_admin(self):
        
        self._testMethodDoc = "Request 'admin/esignconfig' to enable mandatory comment with correct ESignature password and comment"
    ...
    def _verify_state_not_changed(self):
        ...
        for row in rows:
            ...
            if name == "ElectronicSignature":
                ...
                self.assertEqual(value, '1', "verify  '%s' setting is still 0 failed"%name)
