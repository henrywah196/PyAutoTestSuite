...
# Test Case   : 
#
# Description : change config from esign: true, comment: true to esign: false, comment: true
#
################################################################################################
import settings
...
class TestCase(TestCaseTemplate):
    ...
    def test03_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to disable ESignature with incorrect comment"
    ...
    def test04_esignconfig_admin(self):
        ...
        self._testMethodDoc = "Request 'admin/esignconfig' to disable ESignature with correct ESignature password and comment"
    ...
    def _verify_state_changed(self):
        ...
        for row in rows:
            ...
            if name == "ElectronicSignature":
                self.assertEqual(value, '0', "verify  '%s' setting is still 1 failed"%name)
