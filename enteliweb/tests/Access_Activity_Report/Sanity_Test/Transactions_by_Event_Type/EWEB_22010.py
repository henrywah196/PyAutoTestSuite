...
class ReportParameter:
    reportName    = "Transactions by Event Type EWEB_22010"
    reportTitle   = "Transactions by Event Type EWEB_22010"
    site          = "$LocalSite"
    dateRange     = ["This Week"]
...
class TestCase(TestCaseTemplate):
    ...
    def testMain(self, testData):
        ...
        Macros.SelectReportInstance("Access Control\\Transactions by Event Type\\%s"%ReportParameter.reportName)
        ...
        # Prepare test helper
        self.resultFromHelper = AccessActivity.get_filtered_events(ReportParameter, timestamp_format=True, group_by="Event Type")
