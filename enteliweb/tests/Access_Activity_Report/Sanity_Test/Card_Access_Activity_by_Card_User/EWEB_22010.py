...
class ReportParameter:
    reportName    = "Card Access Activity by Card User EWEB_22010"
    reportTitle   = "Card Access Activity by Card User EWEB_22010"
    site          = "$LocalSite"
    dateRange     = ["This Week"]
...
class TestCase(TestCaseTemplate):
    ...
    def testMain(self, testData):
        ...
        Macros.SelectReportInstance("Access Control\\Card Access Activity by Card User\\%s"%ReportParameter.reportName)
        ...
        # Prepare test helper
        self.resultFromHelper = AccessActivity.get_filtered_events(ReportParameter, timestamp_format=True, group_by="Card User")
