...
class ReportParameter:
    reportName    = "Door Activity EWEB_22010"
    reportTitle   = "Door Activity EWEB_22010"
    site          = "$LocalSite"
    dateRange     = ["Previous 2 Days"]
    cardUsers     = {"Find Option" : "Find by Keyword", "Filter By"   : "*"}
    doors         = {"Find Option" : "Find by Keyword", "Filter By"   : "Beta*"}
    events        = "ALL"
    cardNumber    = None
    siteCode      = None
...
class TestCase(TestCaseTemplate):
    ...
    def testMain(self, testData):
        ...
        Macros.SelectReportInstance("Access Control\\Door Activity\\%s"%ReportParameter.reportName)
