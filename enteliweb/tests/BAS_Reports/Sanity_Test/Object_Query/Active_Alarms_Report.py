...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "Active_Alarms_Report.json"))
...
@ddt
class ActiveAlarmsReport(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(ActiveAlarmsReport, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(ActiveAlarmsReport, cls).tearDownClass()
    
    def setUp(self):
        super(ActiveAlarmsReport, self).setUp()
    ...
    def tearDown(self):
        super(ActiveAlarmsReport, self).tearDown()
