...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "Data_Exchange_Settings_Report.json"))
...
@ddt
class DataExchangeSettingsReport(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(DataExchangeSettingsReport, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(DataExchangeSettingsReport, cls).tearDownClass()
    
    def setUp(self):
        super(DataExchangeSettingsReport, self).setUp()
    ...
    def tearDown(self):
        super(DataExchangeSettingsReport, self).tearDown()
        ...
        for item in resultFromReport:
            ...
            for key, value in item.iteritems():
                ...
                if key == "Broadcast Destination":
                    groupObj = getattr(propertyValue, "address")
