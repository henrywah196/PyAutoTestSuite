...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "AdHoc_Calibration_Report.json"))
...
@ddt
class AdHocCalibrationReport(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(AdHocCalibrationReport, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(AdHocCalibrationReport, cls).tearDownClass()
    
    def setUp(self):
        super(AdHocCalibrationReport, self).setUp()
    ...
    def tearDown(self):
        super(AdHocCalibrationReport, self).tearDown()
