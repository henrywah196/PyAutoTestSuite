...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "Objects_In_Manual_Report.json"))
...
class TestCase(TestCaseTemplate):
    ...
    def testMain(self, testData):
        ...
        Macros.SelectReportInstance("Building Automation\\Objects In Manual\\%s"%reportName)
    ...
    def _setupReportInstance(self):
        ...
        if Macros.isReportInstanceExisting("Building Automation\\Objects In Manual\\%s"%reportName):
            Macros.SelectReportInstance("Building Automation\\Objects In Manual\\%s"%reportName)
        else:
            Macros.SelectReportInstance("Building Automation\\Objects In Manual")
        time.sleep(10)
