# coding: utf-8
################################################################################################
# Test Case   : Query comparisons against state text values are case-insensitive
#
# Description : Verify the comparison of state text or active/inactive text should be 
#               case insensitive.
#
################################################################################################
import settings
...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "C1722299.json"))
...
@ddt
class TC1722299(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(TC1722299, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(TC1722299, cls).tearDownClass()
    
    def setUp(self):
        super(TC1722299, self).setUp()
