# coding: utf-8
################################################################################################
# Test Case   : Present Value queries should be able to compare against state text values
#
# Description : Verify support Active/Inactive text for binary object.
#               Verify support state text for multi state object.
#
################################################################################################
import settings
...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "C1722297.json"))
...
@ddt
class TC1722297(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(TC1722297, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(TC1722297, cls).tearDownClass()
    
    def setUp(self):
        super(TC1722297, self).setUp()
