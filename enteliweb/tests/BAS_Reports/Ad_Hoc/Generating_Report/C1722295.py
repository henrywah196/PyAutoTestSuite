# coding: utf-8
########################################################################################
# Test Case   : Property value comparison should support search for zero length string
# Description : Verify property value comparison support search /compare value of 
#               zero length string. for example, looking for objects, which description 
#               property has no input.
########################################################################################
import settings
...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "C1722295.json"))
...
@ddt
class TC1722295(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(TC1722295, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(TC1722295, cls).tearDownClass()
    
    def setUp(self):
        super(TC1722295, self).setUp()
