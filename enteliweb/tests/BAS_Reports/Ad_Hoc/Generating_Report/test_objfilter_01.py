# coding: utf-8
######################################################################################
# Test Case   : Objects filtering by Device Range setting
# Description : Verify the accuracy of the objects returned in the generated report 
#               based on the device range settings.
######################################################################################
import settings
...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "test_objfilter_01.json"))


def getTestingData():
    """
    return a list of testing report instance settings
    """
...
@ddt
class TestObjFilter01(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(TestObjFilter01, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(TestObjFilter01, cls).tearDownClass()
    
    def setUp(self):
        super(TestObjFilter01, self).setUp()
    ...
    def tearDown(self):
        super(TestObjFilter01, self).tearDown()
    ...
    def test01(self, testData):
        ...
        self._testMethodDoc = "Verify report data returned for Device Range (%s)"%deviceRange
