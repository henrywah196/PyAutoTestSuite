# coding: utf-8
######################################################################################
# Test Case   : Objects filtering by advanced query - Basic single property value compare
...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "test_objfilter_03.json"))
...
@ddt
class TestObjFilter03(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(TestObjFilter03, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(TestObjFilter03, cls).tearDownClass()
    
    def setUp(self):
        super(TestObjFilter03, self).setUp()
    ...
    def tearDown(self):
        super(TestObjFilter03, self).tearDown()
