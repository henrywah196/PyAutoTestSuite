# coding: utf-8
######################################################################################
# Test Case   : Property name in property value comparison should not case sensitive
# Description : Verify the property name you used in Edit objet filter should be 
#               case insensitive.
######################################################################################
import settings
...
# Global Settings
JSON_FILE_LOCATION = os.path.abspath(os.path.join(os.path.dirname(__file__), "C1722294.json"))
...
@ddt
class TC1722294(TestCaseTemplate):
    
    @classmethod
    def setUpClass(cls):
        super(TC1722294, cls).setUpClass()
    ...
    def tearDownClass(cls):
        super(TC1722294, cls).tearDownClass()
    
    def setUp(self):
        super(TC1722294, self).setUp()
